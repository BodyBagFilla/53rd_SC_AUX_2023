class cfgAmmo
{
	...
	//class 53rd_M41_Rocket_HEAT : OPTRE_M41_Rocket_HEAT{
	...
	//	class Components {};
	//};
	//class 53rd_M41_Rocket_HEAT_Guided : OPTRE_M41_Rocket_HEAT{
	//	warheadName = "TandemHEAT";
	//	submunitionAmmo = "ammo_Penetrator_Titan_AT";
	//	effectsMissile = "missile3";
	//	hit = 125;
	...
	//	};
	//};
	//class 53rd_M41_Rocket_HEAT_SACLOS : OPTRE_M41_Rocket_HEAT{
	//	model = "\OPTRE_Weapons\Rockets\M41_rocket.p3d";
	//	warheadName = "TandemHEAT";
	//	submunitionAmmo = "ammo_Penetrator_Titan_AT";
	//	effectsMissile = "missile3";
	...
	//};
	//class 53rd_M41_Rocket_HEAT_Thermal : OPTRE_M41_Rocket_HEAT_Thermal{
	//	model = "\OPTRE_Weapons\Rockets\M41_rocket.p3d";
	//	//Seeker, motor, and aerodynamics configuration are found in the included file.
	//	//#include"\OPTRE_Weapons\Rockets\_includes\M41_Ammo_HeatSeek.hpp"
	//};
	//class 53rd_M41_Rocket_HEAT_Laser : OPTRE_M41_Rocket_HEAT{
	//	//Seeker, motor, and aerodynamics configuration are found in the included file.
