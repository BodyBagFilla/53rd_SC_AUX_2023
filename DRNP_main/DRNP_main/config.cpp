...
///// Courtesy of the Portable Drone mod by Pastoman1
...
class CfgMods
{
	class DRNP
	{
		logo="\z\DRNP\addons\main\Data\UI\DRNP_logo.paa";
		logoOver="\z\DRNP\addons\main\Data\UI\DRNP_logo.paa";
		logoSmall="\z\DRNP\addons\main\Data\UI\DRNP_logo.paa";
		dlcColor[]={0,0,0,1};
		hideName=0;
		hidePicture=1;
		tooltipOwned="DRNP";
