...
class CfgWeapons
{
	...
	class 53rd_Ares_Baxoje_Helmet: MA_M56SH_Helmet
	{
		dlc="53rd";
		...
		displayName="[53rd] Ares Custom (Baxoje)";
		hiddenSelectionsTextures[]=
		{
		"\53rd_sc_aux\Armor\Ares_Camo\Customs\Baxoje\53rd_Ares_Baxoje_Helmet.paa",
