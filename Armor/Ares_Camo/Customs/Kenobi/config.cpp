...
class cfgWeapons
{
    ...
    class 53rd_Kenobi_Recon: 53rd_Base_Recon 
    {
        author="53rd Texture Team";
        scope=2;
        scopeArsenal=2;
        side=1;
        displayName="[53rd] Ares Custom (Kenobi)";
        ...
        {
            "53rd_sc_aux\Armor\Ares_Camo\Customs\Kenobi\53rd_Kenobi_Recon_Helmet.paa",
            "53rd_sc_aux\Armor\Ares_Camo\Customs\Recon_Visor_co.paa"
        };
    };
};
