...
class cfgWeapons
{
	...
	class 53rd_Crunchy_Engineer_Helmet_Woodland: MA_M56E_Helmet
		...
		hiddenSelectionsTextures[]=
			{
				"\53rd_sc_aux\Armor\Apollo_Camo\Customs\Crunchy\53rd_Crunchy_Helmet_Woodland.paa",
				"53rd_sc_aux\Armor\Apollo_Camo\Customs\Crunchy\53rd_Crunchy_Visor_Green.paa"
			};
		};
	class 53rd_Crunchy_Engineer_Helmet_Urban: MA_M56E_Helmet
		...
		hiddenSelectionsTextures[]=
			{
				"\53rd_sc_aux\Armor\Apollo_Camo\Customs\Crunchy\53rd_Crunchy_Helmet_Urban.paa",
				"53rd_sc_aux\Armor\Apollo_Camo\Customs\Crunchy\53rd_Crunchy_Visor_Green.paa"
			};
		};
