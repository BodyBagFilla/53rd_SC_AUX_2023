	...
	class CfgVehicles
	{
		...
		class 53rd_CMA_falcon: OPTRE_UNSC_falcon
		{
			...
			displayName="[53rd] UH-144 Falcon  (Unarmed)";
			scope=2;
			scopeCurator=2;
			scopeArsenal=2;
			forceInGarage=1;
			...
			{
				"\53rd_Aux\Generality\Vehicles\Falcon\53rd_Veh_Falcon_Hull.paa",
				"\53rd_Aux\Generality\Vehicles\Falcon\53rd_Veh_Falcon_Wings.paa",
		...
		{
			editorPreview="\OPTRE_Core\Data\logo_ca.paa";
			displayName="[53rd] UH-144 Falcon  (Armed)";
			scope=2;
			scopeCurator=2;
			scopeArsenal=2;
			forceInGarage=1;
			...
			class textureSources
			{
				...
				class Ferret
				{
					...
					textures[]=
					{
					"\53rd_Aux\Generality\Vehicles\Falcon\53rd_Veh_Falcon_Hull_Ferret.paa",
					"\53rd_Aux\Generality\Vehicles\Falcon\53rd_Veh_Falcon_Wings_Ferret.paa",
					"\optre_vehicles_air\falcon\data\falcon_interior_co.paa"
					};
				};
			};
