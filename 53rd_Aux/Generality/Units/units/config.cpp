...
class cfgVehicles
{
	...
	class 53rd_rifleman_Hephaestus_unit: OPTRE_UNSC_Marine_Soldier_Rifleman_AR
	{
		...
		uniformClass="53rd_Heph_Uni_Reservist_Urban";
		backpack="53rd_Backpacks_Rucksack_Urban";
		linkedItems[]=
		{
			"53rd_InvisVest",
	...
	class 53rd_corpman_Hephaestus_unit: 53rd_rifleman_Hephaestus_unit
	{
		...
		{
			"53rd_InvisVest",
			"53rd_Heph_Reservist_Helmet_Urban_Visor",
			"ItemMap",
			"ItemCompass",
			"ItemWatch",
			"ItemRadio",
	...
	class 53rd_Volare_SA_unit: 53rd_Volare_airmen_unit
	{
		...
		uniformClass="53rd_Volare_Uni_Pilot_BlackNCO_F_NCO";
		linkedItems[]=
		{
