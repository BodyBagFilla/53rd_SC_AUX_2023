...
class CfgWeapons
{
    ...
    class UGL_F;  // Ensure this is defined correctly elsewhere if it's an external dependency
    class UBS_F;  // Ensure this is defined correctly elsewhere if it's an external dependency
    class OPTRE_M7;
    ...
    class TCF_CR77;
    class TCF_M247_GPMG;  // Added semicolon here
    class OPTRE_MA5C;
    class OPTRE_MA5B;
    class OPTRE_MA5BGL;
    class OPTRE_MA5CGL;
...
//Working 5-21-2024	
	...
	class 53rd_M247_hmg: TCF_M247_GPMG
	{
		author="53rd SC";
